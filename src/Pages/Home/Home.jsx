...
const Home = () => {
  return (
    <div className='max-w-5xl w-full mx-auto grid: md:grid-col-=s-2 gap-10 item-center mt-20'>
      <div>
        <h1 className='text-white text-5xl font-bold mb-10 relative -mt-6 ml-8'>Hi! I'm Wisdom,
        <br />
        ...
        <p className='text-gray-400 mt-4 leading-relaxed  ml-4'>
        ...
        <div className='mt-6 flex gap-8 ml-4'>
          <Link to='/contact'>
          <button className='bg-green-600 hover:bg-green-800 transition px-8 py-2 rounded-lg text-white font-md'>Contact Me</button>
          </Link>
          <a href='/cv.pdf' download='Wisdom_CV.pdf'>
          <button className='bg-green-600 hover:bg-green-800 transition px-8 py-2 rounded-lg text-white font-md'>Download CV</button>
          </a>
        </div>
      </div>
